...
async def _(event):
        ...
        await sython.send_message('@zmmbot', 'جاري التجميع بواسطة |𝐀𝐋𝐄𝐀𝐑𝐒𝐇 𝐓𝐄𝐀𝐌𖤛')
        channel_entity = await sython.get_entity(bot_username)
        ...
        for i in range(100):
            ...
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                await sython.send_message(event.chat_id, f"لايوجد قنوات  في البوت | IQ")
                break
...
async def _(event):
        ...
        await sython.send_message('@A_MAN9300BOT', 'جاري التجميع بواسطة |𝐀𝐋𝐄𝐀𝐑𝐒𝐇 𝐓𝐄𝐀𝐌𖤛')
        channel_entity = await sython.get_entity(bot_usernamee)
...
async def _(event):
      await event.reply("""السـورس يعمـل |العرش
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
